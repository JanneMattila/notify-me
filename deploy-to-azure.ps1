...
<#
.SYNOPSIS
    Deploys the Notify Me application to Azure App Service.

.DESCRIPTION
    This script creates a deployment package and deploys it to Azure App Service.
...
.EXAMPLE
    .\deploy-to-azure.ps1 -AppName "notify-me" -ResourceGroup "rg-notify-me"

.EXAMPLE
    .\deploy-to-azure.ps1 -AppName "notify-me" -ResourceGroup "rg-notify-me" -WhatIf
#>

param(
    [Parameter(Mandatory = $false, HelpMessage = "Azure App Service name")]
    [string]$AppName = "notify-me",
    
    [Parameter(Mandatory = $false, HelpMessage = "Azure Resource Group name")]
    [string]$ResourceGroup = "rg-notify-me",
...
# Copy required files
Copy-Item -Path "server.js" -Destination "$stagingPath\server.js"
Copy-Item -Path "db.js" -Destination "$stagingPath\db.js"
Copy-Item -Path "push.js" -Destination "$stagingPath\push.js"
Copy-Item -Path "public" -Destination "$stagingPath\public" -Recurse
